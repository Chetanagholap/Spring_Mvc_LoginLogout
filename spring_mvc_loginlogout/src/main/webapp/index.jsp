...
<div class="container">
        ...
        <form action="studentInfo"  method="post">
            <div class="form-control">
                <input type="text" name="sname" placeholder="enter your name" required name="name">
                <label>Username</label>
            </div>
             <div class="form-control">
                <input type="email" name="semail" placeholder="enter your email" required name="email">
                <label>email</label>
            </div>
            <div class="form-control">
                <input type="password" name="spass" placeholder="enter your password" required name="password">
                <label>Password</label>
            </div>
            <div class="form-control">
                <input type="password" name="scpass" placeholder="enter your confirm password"  required name="password">
                <label>Confirm password</label>
            </div>
            <button  class="btn" ><input type="submit" value="">Register</button>
            
            <p class="text">Already have account? <a href="#">Login</a></p>
